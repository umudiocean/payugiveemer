    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-white mb-4">Join the Giveaway</h1>
          <p className="text-squid-grey text-lg max-w-2xl mx-auto">
            Connect your wallet and register with one simple transaction. Get 250M PAYU tokens instantly plus your unique giveaway ticket.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-black/50 border-squid-grey/20 backdrop-blur-xl">
            <CardHeader>
              ...
              <CardDescription className="text-squid-grey">
                {isRegistered 
                  ? 'You are already registered for the giveaway!'
                  : 'One transaction to join the giveaway and receive rewards'
                }
              </CardDescription>
            </CardHeader>
              ...
              {!isConnected ? (
                ...
                <div className="text-center py-8 relative">
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-2 animate-fade-in">Already Registered!</h3>
                    <p className="text-squid-grey animate-fade-in">You have successfully joined the giveaway.</p>
          ...
          <Card className="bg-black/50 border-squid-grey/20 backdrop-blur-xl">
            <CardHeader>
              <CardTitle className="text-white">Your Giveaway Ticket</CardTitle>
              <CardDescription className="text-squid-grey">
                  ...
                  <div className="relative bg-gradient-to-br from-squid-pink/20 to-squid-purple/20 border-2 border-squid-pink/50 rounded-2xl p-8 text-center overflow-hidden">
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center justify-center mb-4">
                        ...
                        <div className="text-sm text-squid-grey animate-fade-in">Lucky Ticket Number</div>
              ...
              <div className="p-5">
                <div className="text-center space-y-3">
                  ...
                  <button
                    onClick={() => {
                      setShowRegistrationSuccess(false)
                      // Don't navigate, just show tasks on same page
                      // Tasks section will automatically show because isRegistered = true and showTasks = true
                    }}
