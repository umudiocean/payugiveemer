...
import {
  en_US_default
} from "./chunk-22HF4D4H.js";

// src/components/ConnectButton/ConnectButton.tsx
import React61, { useContext as useContext23, useEffect as useEffect18, useState as useState15 } from "react";
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-PQJDYWVZ.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-76OUGVJ2.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-GLICGTYE.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-UC7Z4T6O.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-RGKVTIVE.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-3SKVJ2RK.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-GYCPH6AT.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-V2HAEAHG.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-JDDVMLRA.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-3W6WVVOI.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-UWDENI2F.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-NAI3OICG.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-H7BFRWP5.js")).default;
    case "zh":
    case "zh-CN":
      return (await import("./zh_CN-BO5MSGV2.js")).default;
    default:
      return (await import("./en_US-76OUGVJ2.js")).default;
  }
};
...
function useFingerprint() {
  const fingerprint = useCallback3(() => {
    setRainbowKitVersion({ version: "1.3.6" });
  }, []);
  useEffect9(() => {
    fingerprint();
  }, [fingerprint]);
...
function ConnectButton({
  ...
  return ready ? /* @__PURE__ */ React61.createElement(ConnectButtonRenderer, null, ({
    account,
    chain,
    mounted,
    openAccountModal,
    ...
    return /* @__PURE__ */ React61.createElement(Box, {
    ...
    }, ready2 && account && connectionStatus === "connected" ? /* @__PURE__ */ React61.createElement(React61.Fragment, null, chain && (chains.length > 1 || unsupportedChain) && /* @__PURE__ */ React61.createElement(Box, {
      alignItems: "center",
      ...
      height: "24",
      paddingX: "4"
    }, i18n2.t("connect_wallet.wrong_network.label")) : /* @__PURE__ */ React61.createElement(Box, {
      alignItems: "center",
      display: "flex",
      gap: "6"
